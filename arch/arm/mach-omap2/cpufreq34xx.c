...
static struct omap_opp_def __initdata omap36xx_opp_def_list[] = {
	...
	/* MPU OPP2 - OPP100 */
	OMAP_OPP_DEF("mpu", true,  600000000,  1170000),   
	/* MPU OPP3 - OPP-Turbo */
	OMAP_OPP_DEF("mpu", true,  800000000,   1300000),
	/* MPU OPP4 - OPP-SB */
	OMAP_OPP_DEF("mpu", true,  1000000000, 1340500),
	...
	/* DSP OPP1 - OPP50 */
	OMAP_OPP_DEF("iva", true,  260000000, 925000),
	/* DSP OPP2 - OPP100 */
	OMAP_OPP_DEF("iva", true,  520000000, 1170000),
	/* DSP OPP3 - OPP-Turbo */
	OMAP_OPP_DEF("iva", true, 660000000, 1300000),
	/* DSP OPP4 - OPP-SB */
	OMAP_OPP_DEF("iva", true, 800000000, 1340500),
};
